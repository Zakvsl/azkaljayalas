                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea name="address" 
                                  ...
                                  rows="3"
                                  required
                                  class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 @error('address') border-red-300 @enderror">{{ old('address', $order->address) }}</textarea>
                        @error('address')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <select name="project_type" 
                            ...
                            <option value="pagar" {{ old('project_type', $order->project_type) == 'pagar' ? 'selected' : '' }}>Pagar</option>
                            <option value="kanopi" {{ old('project_type', $order->project_type) == 'kanopi' ? 'selected' : '' }}>Kanopi</option>
                            <option value="railing" {{ old('project_type', $order->project_type) == 'railing' ? 'selected' : '' }}>Railing</option>
                            <option value="pintu" {{ old('project_type', $order->project_type) == 'pintu' ? 'selected' : '' }}>Pintu</option>
                            <option value="teralis" {{ old('project_type', $order->project_type) == 'teralis' ? 'selected' : '' }}>Teralis</option>
                            <option value="lainnya" {{ old('project_type', $order->project_type) == 'lainnya' ? 'selected' : '' }}>Lainnya</option>
                        </select>
                        @error('project_type')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    ...
                    <div>
                        ...
                        <select name="material_type" 
                            ...
                            <option value="hollow" {{ old('material_type', $order->material_type) == 'hollow' ? 'selected' : '' }}>Hollow</option>
                            <option value="besi" {{ old('material_type', $order->material_type) == 'besi' ? 'selected' : '' }}>Besi</option>
                            <option value="stainless" {{ old('material_type', $order->material_type) == 'stainless' ? 'selected' : '' }}>Stainless Steel</option>
                            <option value="aluminium" {{ old('material_type', $order->material_type) == 'aluminium' ? 'selected' : '' }}>Aluminium</option>
                        </select>
                        @error('material_type')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                        ...
                        <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                            <div>
                                ...
                                <input type="number" 
                                       ...
                                       step="0.01"
                                       min="0"
                                       value="{{ old('length', $order->dimensions['length'] ?? '') }}"
                                       placeholder="0.00"
                            ...
                            <div>
                                ...
                                <input type="number" 
                                       ...
                                       step="0.01"
                                       min="0"
                                       value="{{ old('width', $order->dimensions['width'] ?? '') }}"
                                       placeholder="0.00"
                                       class="block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                            </div>
                            <div>
                                ...
                                <input type="number" 
                                       ...
                                       step="0.01"
                                       min="0"
                                       value="{{ old('height', $order->dimensions['height'] ?? '') }}"
                                       placeholder="0.00"
                                       class="block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                            </div>
                            <div>
                                ...
                                <input type="number" 
                                       ...
                                       step="0.1"
                                       min="0"
                                       value="{{ old('thickness', $order->dimensions['thickness'] ?? '') }}"
                                       placeholder="0.0"
                                       class="block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                            </div>
                        </div>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea name="description" 
                                  ...
                                  class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">{{ old('description', $order->description) }}</textarea>
                    </div>
                </div>
            </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="date" 
                               ...
                               id="completion_date" 
                               value="{{ old('completion_date', $order->completion_date ? $order->completion_date->format('Y-m-d') : '') }}"
                               class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500">
                    </div>
